...
function buildStudio(): Plan {
  ...
  return {
    ...
    walls,
    openings: [
      { id: 'o-door-entry', wallId: 'w-n', t: 0.613, width: 0.9, kind: 'door', swing: 'left' },
    ...
    items: [
      ...
      item('st-desk', 'desk-oak', { x: 2.7, y: 0.5 }, 0, 'r-main'),
      item('st-chair', 'office-chair', { x: 2.7, y: 1.3 }, 180, 'r-main', 2),
      item('st-shelf', 'storage-shelf-slim', { x: 4.0, y: 0.28 }, 0, 'r-main'),
...
function build59(): Plan {
  ...
  return {
    ...
    openings: [
      ...
      // 안방 욕실 — 안방에서만 진입
      { id: 'o-door-mbath', wallId: 'w-mb-h', t: 0.79, width: 0.7, kind: 'door', swing: 'right' },
    ...
    items: [
      ...
      item('t59-tv', 'tv-standby', { x: 6.3, y: 2.5 }, 0, 'r-living', 1),
      item('t59-console', 'storage-console', { x: 7.6, y: 2.45 }, 0, 'r-living'),
      ...
      // 주방
      item('t59-island', 'kitchen-island', { x: 3.85, y: 1.0 }, 90, 'r-kitchen'),
      ...
      // 안방 (침대는 부속욕실 반대편)
      item('t59-bed', 'bed-queen', { x: 1.15, y: 4.75 }, 90, 'r-master'),
      item('t59-night', 'nightstand', { x: 2.6, y: 3.95 }, 0, 'r-master'),
      item('t59-wardrobe', 'storage-wardrobe', { x: 2.85, y: 6.1 }, 90, 'r-master', 2),
      // 침실 (서재)
      item('t59-desk', 'desk-oak', { x: 1.0, y: 0.55 }, 0, 'r-bed'),
      item('t59-chair', 'office-chair', { x: 1.0, y: 1.35 }, 180, 'r-bed', 2),
      item('t59-bookcase', 'bookcase-wide', { x: 2.95, y: 1.1 }, 90, 'r-bed'),
      item('t59-plant2', 'plant-monstera', { x: 0.35, y: 1.9 }, 0, 'r-bed'),
      // 공용 욕실 · 현관
      item('t59-rug2', 'rug-runner', { x: 1.6, y: 2.95 }, 0, 'r-bath', 1),
      item('t59-shoe', 'storage-shelf-slim', { x: 8.5, y: 0.28 }, 0, 'r-entry'),
    ],
    updatedAt: new Date().toISOString(),
  };
}
...
function build84(): Plan {
  ...
  return {
    ...
    openings: [
      ...
      { id: 'o-door-hall', wallId: 'w-mid-v', t: 0.905, width: 1.0, kind: 'door', swing: 'right' },
      { id: 'o-door-bed2', wallId: 'w-mid-v', t: 0.321, width: 0.9, kind: 'door', swing: 'left' },
      { id: 'o-door-bed3', wallId: 'w-mid-v', t: 0.536, width: 0.9, kind: 'door', swing: 'right' },
      { id: 'o-door-bath', wallId: 'w-mid-v', t: 0.756, width: 0.8, kind: 'door', swing: 'left', open: false },
      { id: 'o-door-master', wallId: 'w-k-b', t: 0.25, width: 0.9, kind: 'door', swing: 'left' },
      // 안방 욕실 — 안방에서만 진입 (w-k-b 위 문, 안방↔욕실)
      { id: 'o-door-mbath', wallId: 'w-k-b', t: 0.75, width: 0.7, kind: 'door', swing: 'right' },
      { id: 'o-door-pantry', wallId: 'w-p-h', t: 0.5, width: 0.8, kind: 'door', swing: 'left' },
    ...
    items: [
      ...
      item('t84-console', 'storage-console', { x: 7.0, y: 3.72 }, 0, 'r-living'),
      item('t84-tv', 'tv-standby', { x: 8.2, y: 3.75 }, 0, 'r-living', 1),
      item('t84-dining', 'dining-set-4', { x: 5.0, y: 4.6 }, 0, 'r-living'),
      item('t84-lamp', 'lamp-floor', { x: 10.5, y: 8.0 }, 0, 'r-living'),
      item('t84-plant', 'plant-olive', { x: 3.95, y: 8.0 }, 0, 'r-living'),
      ...
      item('t84-dresser', 'dresser', { x: 10.0, y: 2.95 }, 180, 'r-master'),
      // 침실 2
      ...
      // 침실 3 (서재)
      item('t84-desk', 'desk-oak', { x: 1.15, y: 5.2 }, 180, 'r-bed3'),
      item('t84-chair', 'office-chair', { x: 1.15, y: 4.35 }, 0, 'r-bed3', 2),
      item('t84-bookcase', 'bookcase-wide', { x: 3.25, y: 4.3 }, 90, 'r-bed3'),
